...
Additionally, place this [bridge.py](???) file in your `openpilot/tools/sim` directory. This customized bridge file contains the whole black-box attack implementation.
